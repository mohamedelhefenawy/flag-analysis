...
export default function DifferentCard({
  ...
  const shared = {
    className:
      `${className} cursor-pointer group relative w-full  rounded-[16px] px-6 py-7 md:px-10 md:py-8 border overflow-hidden transition-[background,border-color,box-shadow] duration-300 ease-in-out`,
    style: {
      background: bg,
      borderColor: border,
